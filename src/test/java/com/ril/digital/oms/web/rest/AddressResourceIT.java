...
import com.ril.digital.oms.repository.AddressRepository;
import com.ril.digital.oms.service.dto.AddressDTO;
import com.ril.digital.oms.service.mapper.AddressMapper;
...
class AddressResourceIT {
    ...
    private static final String DEFAULT_LANDMART = "AAAAAAAAAA";
    private static final String UPDATED_LANDMART = "BBBBBBBBBB";
    ...
    void createAddress() throws Exception {
        ...
        assertThat(testAddress.getLandmart()).isEqualTo(DEFAULT_LANDMART);
    }
    ...
    void getAllAddresses() throws Exception {
        ...
        restAddressMockMvc
            ...
            .andExpect(jsonPath("$.[*].landmart").value(hasItem(DEFAULT_LANDMART)));
    }
    ...
    void getAddress() throws Exception {
        ...
        restAddressMockMvc
            ...
            .andExpect(jsonPath("$.landmart").value(DEFAULT_LANDMART));
    }
    ...
    void putExistingAddress() throws Exception {
        ...
        assertThat(testAddress.getLandmart()).isEqualTo(UPDATED_LANDMART);
    }
