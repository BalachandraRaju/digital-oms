...
import com.ril.digital.oms.repository.CustomerRepository;
import com.ril.digital.oms.service.dto.CustomerDTO;
import com.ril.digital.oms.service.mapper.CustomerMapper;
...
class CustomerResourceIT {
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer().name(DEFAULT_NAME).email(DEFAULT_EMAIL).phone(DEFAULT_PHONE);
        return customer;
    }
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer().name(UPDATED_NAME).email(UPDATED_EMAIL).phone(UPDATED_PHONE);
        return customer;
    }
