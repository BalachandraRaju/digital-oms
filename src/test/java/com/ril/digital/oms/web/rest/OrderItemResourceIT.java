...
import com.ril.digital.oms.repository.OrderItemRepository;
import com.ril.digital.oms.service.dto.OrderItemDTO;
import com.ril.digital.oms.service.mapper.OrderItemMapper;
...
class OrderItemResourceIT {
    ...
    private static final ArticleType UPDATED_ARTICLE_TYPE = ArticleType.HD;
    ...
    void createOrderItem() throws Exception {
        ...
        assertThat(testOrderItem.getArticle()).isEqualTo(DEFAULT_ARTICLE);
        assertThat(testOrderItem.getArticleType()).isEqualTo(DEFAULT_ARTICLE_TYPE);
        assertThat(testOrderItem.getStatus()).isEqualTo(DEFAULT_STATUS);
        assertThat(testOrderItem.getTatDate()).isEqualTo(DEFAULT_TAT_DATE);
        assertThat(testOrderItem.getTahHourOfDay()).isEqualTo(DEFAULT_TAH_HOUR_OF_DAY);
    }
    ...
    void putExistingOrderItem() throws Exception {
        ...
        OrderItem testOrderItem = orderItemList.get(orderItemList.size() - 1);
        assertThat(testOrderItem.getArticle()).isEqualTo(UPDATED_ARTICLE);
        assertThat(testOrderItem.getArticleType()).isEqualTo(UPDATED_ARTICLE_TYPE);
        assertThat(testOrderItem.getStatus()).isEqualTo(UPDATED_STATUS);
        assertThat(testOrderItem.getTatDate()).isEqualTo(UPDATED_TAT_DATE);
        assertThat(testOrderItem.getTahHourOfDay()).isEqualTo(UPDATED_TAH_HOUR_OF_DAY);
    }
