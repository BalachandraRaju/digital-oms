...
import com.ril.digital.oms.repository.OrderRepository;
import com.ril.digital.oms.service.dto.OrderDTO;
import com.ril.digital.oms.service.mapper.OrderMapper;
...
class OrderResourceIT {
    ...
    private static final Channel DEFAULT_CHANNEL = Channel.RD;
    private static final Channel UPDATED_CHANNEL = Channel.MJS;
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order().channel(DEFAULT_CHANNEL);
        return order;
    }
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order order = new Order().channel(UPDATED_CHANNEL);
        return order;
    }
    ...
    void putExistingOrder() throws Exception {
        ...
        updatedOrder.channel(UPDATED_CHANNEL);
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.channel(UPDATED_CHANNEL);
