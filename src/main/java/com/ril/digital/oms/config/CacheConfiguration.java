package com.ril.digital.oms.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.ril.digital.oms.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.ril.digital.oms.repository.UserRepository.USERS_BY_EMAIL_CACHE);
